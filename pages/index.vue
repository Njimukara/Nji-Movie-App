...
export default {
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'keywords',
          name: 'keywords',
          content: 'movies, stream, stremaing, vue',
        },
      ],
    }
  },
  ...
  methods: {
    async getMovies() {
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=6a1fbfc519fbac3eb8999dcf9fbe0b52&language=en-US&page=1')
    ...
    async searchMovies() {
      ...
      const data = axios.get
        (`https://api.themoviedb.org/3/search/movie?api_key=6a1fbfc519fbac3eb8999dcf9fbe0b52&language=en-US&page=1&query=${this.searchInput}`)
      const result = await data
      result.data.results.forEach((movie)=> {
